...
import compas from "@/public/images/customer.png"
  ...
  return (
    <div className="pt-[6rem] pb-[3rem]">
      ...
      <p className="w-[90%] sm:w-[85%] md:w-[75%] lg:w-[65%] xl:w-[55%] mx-auto text-[17px] text-center text-gray-950 opacity-80">
        ...
        nam ipsa error nesciunt ducimus officia non, necessitatibus totam, porro
        exercitationem architecto molestiae maiores dolores consequatur vitae
        dignissimos omnis cumque distinctio.
      </p>
      <p className="text-center mt-[1.7rem] font-[500] cursor-pointer text-blue-600">
        Explore Details
      </p>
      <div className="mt-[2rem] text-center w-[80%] mx-auto ">
            <Image src={compas} alt="company"/>
      </div>
    </div>
  );
};
